...
信箱裡躺著幾百封未讀信件？下載資料夾堆滿了累積好幾年的 PDF 和過期截圖？在這個資訊過載的時代，數位雜物正以驚人的速度佔據你的生活。這些雜事不難處理，但消磨耐心又覺得沒意義，我們先看下以下典型的例子：
...
這些事情的共同點是：處理起來高重複性、極其耗時而且枯燥無聊，可是。它們不值得親自動手，卻又不會自動消失。
...
打開 Claude Desktop，用 Claude Pro（或 Max）帳號登入。登入成功後會看到 Claude 的主畫面，上方有兩個分頁：**Chat** 和 **Code**。

- **Chat**：就是一般的 AI 對話，跟網頁版一樣。
- **Code**：這才是我們的秘書辦公室，可以讀寫你電腦裡的檔案、執行指令、幫你自動化各種任務。
